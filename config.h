...
static char *fonts[]          = { "monospace:size=14", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true"  };
...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "120x34", "-f", "monospace:size=16", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_p,			spawn,		{.v = (const char*[]){ "agenda", NULL } } },
	...
	{ MODKEY,			XK_n,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "nvim", "$CEREBRUM_PATH/org/$HOST_scratchpad.org", NULL } } },
